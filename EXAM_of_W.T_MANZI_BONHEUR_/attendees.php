...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO attendees(attendee_id, user_id, workshop_id,registration_date) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $attendee_id, $user_id,$workshop_id, $registration_date);
