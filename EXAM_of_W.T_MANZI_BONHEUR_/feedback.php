...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO feedback(feedback_id, workshop_id, user_id, rating, comments,feedback_date) VALUES (?, ?, ?, ?, ? ,? )");
    $stmt->bind_param("isssss", $feedback_id, $workshop_id, $user_id, $rating,$comments,$feedback_date);
    // Set parameters and execute
    $feedback_id = $_POST['driver_id'];
    $workshop_id = $_POST['user_id'];
    $user_id = $_POST['license_number'];
    $rating = $_POST['car_model'];
    $comments = $_POST['capacity'];
    $feedback_date = $_POST['capacit'];
