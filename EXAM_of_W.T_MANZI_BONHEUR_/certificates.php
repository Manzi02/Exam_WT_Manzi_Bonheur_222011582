...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <label for="certificate_id">certificate_id:</label>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $certificate_id = $row['certificate_id']; // Fetch the certificate_id
        echo "<tr>
            ...
            <td><a style='padding:4px' href='delete_certificates.php?certificate_id=$certificate_id'>Delete</a></td> 
            <td><a style='padding:4px' href='update_certificates.php?certificate_id=$certificate_id'>Update</a></td> 
        </tr>";
    }
